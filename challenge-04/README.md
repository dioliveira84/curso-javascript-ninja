...
console.log(isTruthy({}));
console.log(isTruthy([]));
console.log(isTruthy(3.15));
console.log(isTruthy(100));
console.log(isTruthy("Diogo Oliveira"));
console.log(isTruthy(12 * 2));
...
if (totalPessoas > carro.assentos) {
  var qtdePessoasQueCabem = carro.assentos - carro.quantidadePessoas;
  var pluralOuSingular = qtdePessoasQueCabem === 1 ? 'pessoa' : 'pessoas';
  return 'Só cabem mais ' + qtdePessoasQueCabem + ' ' + pluralOuSingular + '!'
}
